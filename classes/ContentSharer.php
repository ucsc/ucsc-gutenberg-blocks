...
class ContentSharer
{
	function __construct()
	{
		add_action(
			'rest_api_init', function () {
				register_rest_route(
					'ucscgutenbergblocks/v1', '/sites/', array(
					'methods' => 'GET',
				...
				register_rest_route(
					'ucscgutenbergblocks/v1', '/posttypes', array(
					'methods' => 'GET',
				...
				register_rest_route(
					'ucscgutenbergblocks/v1', '/post', array(
					'methods' => 'GET',
	...
	{
		register_block_type(
			'ucscblocks/contentsharer', array(
	...
	function get_post($request)
	{
		...
		if (!$posttype) { return "Set Post Type";
		}

		$siteid = isset($parameters['siteid']) ? $parameters['siteid'] : false;
		if (!$siteid) { return "Set Site ID";
		}
