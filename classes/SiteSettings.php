	...
	function __construct()
	{
		...
		add_action(
			'rest_api_init', function () {
				register_rest_route(
					'ucscgutenbergblocks/v1', '/departmentcode/', array(
					'methods' => 'GET',
				...
				register_rest_route(
					'ucscgutenbergblocks/v1', '/subjectcode/', array(
					'methods' => 'GET',
				...
				register_rest_route(
					'ucscgutenbergblocks/v1', '/cddepartmentcode/', array(
					'methods' => 'GET',
				...
				register_rest_route(
					'ucscgutenbergblocks/v1', '/divisioncode/', array(
					'methods' => 'GET',
