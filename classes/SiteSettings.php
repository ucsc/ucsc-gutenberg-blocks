...
class ucsc_services_block_class_site_settings
{
	...
	add_action('rest_api_init', function () {
		register_rest_route('ucscserviceblocks/v1', '/departmentcode/', array(
		'methods' => 'GET',
		'callback' => array($this, 'departmentcode'),
		'permission_callback' => function() {return true;}
		));
		register_rest_route('ucscserviceblocks/v1', '/subjectcode/', array(
		'methods' => 'GET',
		'callback' => array($this, 'subjectcode'),
		'permission_callback' => function() {return true;}
		));
		register_rest_route('ucscserviceblocks/v1', '/cddepartmentcode/', array(
		'methods' => 'GET',
		'callback' => array($this, 'cddepartmentcode'),
		'permission_callback' => function() {return true;}
		));
		register_rest_route('ucscserviceblocks/v1', '/divisioncode/', array(
		'methods' => 'GET',
  ...
  function settings()
  {
	...
	add_settings_field('ldap_url', 'LDAP URL', array($this, 'ldapURL'), 'ucsc_service_blocks_settings_page', 'ucsc_service_blocks_section');
	...
	register_setting('ucsc_service_blocks', 'ldap_url', array('sanitize_callback' => 'sanitize_text_field', 'default' => ''));
