  ...
  wp.blocks.registerBlockType("ucscblocks/accordion", {
    ...
    edit: function edit(_ref) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["InspectorControls"], {
        ...
        open: "true"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("summary", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("input", {
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_CampusDirectory_CampusDirectoryDepartmentDropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components//CampusDirectory/CampusDirectoryDepartmentDropdown */ "./src/components/CampusDirectory/CampusDirectoryDepartmentDropdown.js");
...
var CampusDirectory = function CampusDirectory() {
  wp.blocks.registerBlockType("ucscblocks/campusdirectory", {
    ...
    edit: function edit(_ref) {
      ...
      var localDeptOrDiv;
      var setLocalDeptOrDiv;

      if (typeof deptOrDiv === 'undefined') {
        var _useState5 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useState"])('dept');

        var _useState6 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState5, 2);

        localDeptOrDiv = _useState6[0];
        setLocalDeptOrDiv = _useState6[1];
        setAttributes({
          deptOrDiv: 'dept'
        });
      } else {
        var _useState7 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useState"])(deptOrDiv);

        var _useState8 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState7, 2);

        localDeptOrDiv = _useState8[0];
        setLocalDeptOrDiv = _useState8[1];
      }
      ...
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("hr", null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_components_CampusDirectory_CampusDirectoryDepartmentDropdown__WEBPACK_IMPORTED_MODULE_3__["default"], {
        label: "Department",
...
var DepartmentDropdown = function DepartmentDropdown(_ref) {
  ...
  if (typeof department === 'undefined') {
    ...
    localDepartment = _useState4[0];
    setLocalDepartment = _useState4[1];
    setAttributes({
      department: '---'
    });
  } else {
    var _useState5 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useState"])(department);

    var _useState6 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState5, 2);

    localDepartment = _useState6[0];
    setLocalDepartment = _useState6[1];
  }
  ...
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    fetch('/wp-json/ucscgutenbergblocks/v1/departmentcode').then(function (res) {
      ...
      var resp = JSON.parse(text).map(function (item) {
        return {
          label: item.label,
          value: item.label
        };
...
var DivisionDropdown = function DivisionDropdown(_ref) {
  ...
  if (typeof division === 'undefined') {
    ...
    localDivision = _useState4[0];
    setLocalDivision = _useState4[1];
    setAttributes({
      division: '---'
    });
  } else {
    var _useState5 = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useState"])(division);

    var _useState6 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState5, 2);

    localDivision = _useState6[0];
    setLocalDivision = _useState6[1];
  }
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, divisions.length > 0 && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    ...
    value: division,
    options: divisions,
    onChange: function onChange(newDivision) {
      setAttributes({
...
Object(_blocks_ClassSchedule__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_blocks_Accordion__WEBPACK_IMPORTED_MODULE_3__["default"])(); // FeedbackForm();
